  ...
  $("[data-fp=multiple]").click(function () {
    ...
    window.SetUrl = function (items) {
      ...
      items.forEach(function (item) {
        $(_this2).parent().find($(_this2).attr("data-fp-container")).append("\n                    <li>\n                        <input type=\"hidden\" name=\"".concat($(_this2).attr("data-fp-name"), "\" value=\"").concat(item.url, "\">\n                        <img src=\"").concat(item.url, "\" class=\"h-20 w-20 border border-gray-300 object-cover\">\n                    </li>   \n                "));
      });
    };
  });
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/admin.js")))

...
export default function EditProductPage() {
    return (
        <div class="card mx-auto max-w-3xl">
            <div class="card-header card-header-title">Edit Product</div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <ul id="gallery" class="flex flex-wrap gap-2">
                            ...
                            <li class="relative group h-20 w-20 rounded border border-gray-300 overflow-hidden">
                                ...
                                <img src="https://cdn.pixabay.com/photo/2016/12/06/09/31/blank-1886008__340.png" class="w-full h-full object-cover" />
                            </li>
                        </ul>
...
<Link to="/products/4/attributes" className="btn btn-outline-secondary">Attributes</Link>
<Link to="/products/3/variations" className="btn btn-outline-secondary">Variations</Link>
            </div>
        </div>
    )
}
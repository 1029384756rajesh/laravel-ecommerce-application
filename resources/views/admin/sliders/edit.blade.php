...
<div class="container my-4 px-3">
    ...
    <div class="card">
        ...
        <form enctype="multipart/form-data" action="{{ route('admin.sliders.update', ['slider' => $slider->id]) }}" class="card-body" method="POST" novalidate>
            @csrf
            @method('PATCH')
            ...
            <div class="mb-3">
                ...
                <img src="/uploads/{{ $slider->image_url }}" class="img-fluid mt-1" width="80" height="80" alt="">
                @error('image')
                    <div class="text-danger mt-1">{{ $message }}</div>
                @enderror
            </div>

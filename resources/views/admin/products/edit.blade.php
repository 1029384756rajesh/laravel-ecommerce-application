...
@section("content")
    <form action="/admin/products/{{ $product->id }}" method="post" class="card mx-auto max-w-3xl" enctype="multipart/form-data">
        @csrf
        @method("patch")
        ...
        <div class="card-body">
            ...
            <div>
                <label id="images" class="form-label">Images</label>
